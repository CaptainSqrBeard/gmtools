...
local sublock = require("GMT_Scripts.Objects.Submarine.sublock")
...
function module.initialize()
    ...
    command.AssignSharedCommand("subdata",function (args, interface)
        ...
        if Submarine.LockX or Submarine.LockY or (sublock.submarineLocks[sub] ~= nil and (sublock.submarineLocks[sub].x or sublock.submarineLocks[sub].y)) then
            local lockedText = ""
            if Submarine.LockX or sublock.submarineLocks[sub].x then lockedText = lockedText.."X" end
            if Submarine.LockY or sublock.submarineLocks[sub].y then lockedText = lockedText.."Y" end
