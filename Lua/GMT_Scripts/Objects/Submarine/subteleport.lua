...
command.AddCommand("subtp",GMT.Lang("Help_SubmarineTeleport"),true,nil,{
...
command.AssignClientCommand("subtp",function(client,cursor,args)
    ...
    elseif args[2] == "start" then
        if Level.Loaded == nil then
            utils.SendConsoleMessage("GMTools: "..GMT.Lang("Error_LevelIsNotLoaded"),client,Color(255,0,128,255))
            return
        end
    ...
    elseif args[2] == "end" then
        ...
        if #split == 2 then
            ...
            if x ~= nil and y ~= nil then
                ...
                utils.SendConsoleMessage("GMTools: "..GMT.Lang("CMD_SubmarineTp_UnknownType"),client,Color(255,0,128,255))
                return
            end
        else
            utils.SendConsoleMessage("GMTools: "..GMT.Lang("CMD_SubmarineTp_UnknownType"),client,Color(255,0,128,255))
    ...
    if endPos ~= nil then
        utils.SendConsoleMessage(GMT.Lang("CMD_SubmarineTp_Success", {sub.Info.Name, math.floor(sub.WorldPosition.x), math.floor(sub.WorldPosition.y), math.floor(endPos.x), math.floor(endPos.y)}),client,Color(255,0,255,255))
...
command.AssignServerCommand("subtp",function(args)
    ...
    if args[2] == nil then
        utils.NewConsoleMessage("GMTools: "..GMT.Lang("CMD_SubmarineTp_NoPosition"),Color(255,0,128,255))
        return
    elseif args[2] == "cursor" then
        utils.NewConsoleMessage("GMTools: "..GMT.Lang("CMD_SubmarineTp_NoCursor"),Color(255,0,128,255))
        return
    elseif args[2] == "start" then
        if Level.Loaded == nil then
            utils.NewConsoleMessage("GMTools: "..GMT.Lang("Error_LevelIsNotLoaded"),Color(255,0,128,255))
            return
        end
        endPos = Level.Loaded.StartPosition
    ...
    elseif args[2] == "end" then
        ...
        if #split == 2 then
            ...
            if x ~= nil and y ~= nil then
                ...
                utils.NewConsoleMessage("GMTools: "..GMT.Lang("CMD_SubmarineTp_UnknownType"),Color(255,0,128,255))
                return
            end
        else
            utils.NewConsoleMessage("GMTools: "..GMT.Lang("CMD_SubmarineTp_UnknownType"),Color(255,0,128,255))
    ...
    if endPos ~= nil then
        utils.NewConsoleMessage(GMT.Lang("CMD_SubmarineTp_Success", {sub.Info.Name, math.floor(sub.WorldPosition.x), math.floor(sub.WorldPosition.y), math.floor(endPos.x), math.floor(endPos.y)}),Color(255,0,255,255))
        sub.SetPosition(endPos);
    end
end)