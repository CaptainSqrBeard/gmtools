...
function module.initialize()
    ...
    command.AssignSharedCommand("giveperm",function (args, interface)
        ...
        if args[2] == "all" then
            ...
            playerdb.playerDatabase[r_client.SteamID].Permissions = command.ListAllCommands()
        ...
        for i = 2, #args, 1 do
            ...
            if not error and not utils.Contains(command.ConsoleCommands, cmd) then
            ...
            if not error then
                interface.showMessage(lang.Lang("CMD_GivePerm_added",{cmd}),Color(255,255,255,255))
