...
function module.addSmite(name, help, func)
...
function module.initialize()
    -- Smites
    module.addSmite("gib",lang.Lang("CMD_Smite_gib"), function (char, interface)
    ...
    module.addSmite("gigacancer",lang.Lang("CMD_Smite_gigacancer"), function (char, interface)
    ...
    module.addSmite("drunk",lang.Lang("CMD_Smite_drunk"), function (char, interface)
        local limb = char.AnimController.MainLimb
    ...
    module.addSmite("orangeboy",lang.Lang("CMD_Smite_orangeboy"), function (char, interface)
    ...
    module.addSmite("longstun",lang.Lang("CMD_Smite_longstun"), function (char, interface)
        local limb = char.AnimController.MainLimb
