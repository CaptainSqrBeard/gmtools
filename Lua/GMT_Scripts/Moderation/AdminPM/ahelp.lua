...
local function sendAHelpToAdmins(sender,recipient,msg)
    ...
    utils.SendConsoleMessage(GMT.Lang("CMD_AHelp_con_for_admin_L2",{msg}),recipient,Color(255,255,255,255))
    utils.SendConsoleMessage(GMT.Lang("CMD_AHelp_con_for_admin_L3",{sender.SessionId}),recipient,Color(255,255,255,255))
...
command.AddCommand("ahelp",GMT.Lang("Help_AHelp"),false,nil,{{name="msg",desc=GMT.Lang("Args_AHelp_msg")}})

command.AssignClientCommand("ahelp",function(client,cursor,args)
    if GMT.Config.Vars.ahelp_enabled == false then
        utils.SendConsoleMessage("GMTools: "..GMT.Lang("CMD_AHelp_disabled"),client,Color(255,0,0,255))
        return
    end
    ...
    -- For sender
    utils.SendConsoleMessage(GMT.Lang("CMD_AHelp_con_for_player_L1",{client.Name}),client,Color(255,0,0,255))
    utils.SendConsoleMessage(GMT.Lang("CMD_AHelp_con_for_player_L2",{msg}),client,Color(255,255,255,255))
...
command.AssignServerCommand("ahelp",function(args)
    utils.NewConsoleMessage("GMTools: "..GMT.Lang("Error_bad_console"),Color(255,0,0,255),false) -- how you will adminPM something that isn't a client?
end)
