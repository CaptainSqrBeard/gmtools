...
function module.sendAdminPMToPlayer(sender,recipient,msg)
...
function module.sendConsolePMToPlayer(recipient,msg)
...
function module.initialize()
    ...
    command.AssignSharedCommand("adminpm",function (args, interface)
        ...
        if interface.executor ~= nil then
            ...
            module.sendAdminPMToPlayer(interface.executor,r_client,msg)
        else
            -- Set name of host
            sender_name = lang.Lang("Console")

            -- Message for recipient
            module.sendConsolePMToPlayer(r_client,msg)
        end
