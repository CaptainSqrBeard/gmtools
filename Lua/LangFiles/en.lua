...
-- AHelp
lang_files["Args_AHelp_msg"] = "Message to send"
...
-- GhostChat
lang_files["Args_GhostChat_msg"] = "A message to send in ghost chat"

-- Help
lang_files["Args_Help_commands"] = "Input name of command to get more info about it, or type 'all' to get command list"

-- NearItems
lang_files["Args_NearItems_range"] = "Searching range, shaped as rectangle. Default: 100"
...
lang_files["Args_Jobban_duration"] = "Duration of job-ban. Leave empty to permanent ban"
...
lang_files["Args_UnJobban_job"] = "Job that will be unbanned for this player"

-- Smite
lang_files["Args_Smite_mode"] = "Smite to do. Type \"help\" here to get list of smites"
